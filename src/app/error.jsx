      ...
      <div className="container mx-auto min-h-screen px-6 py-12 lg:flex lg:items-center lg:gap-12">
        <div className="wf-ull lg:w-1/2">
          ...
          <div className="mt-6 flex items-center gap-x-3">
            ...
            <Link
              href="/"
              className="w-1/2 shrink-0 rounded-lg bg-green-500 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-500 sm:w-auto"
            >
              Take me home
            </Link>
          </div>
